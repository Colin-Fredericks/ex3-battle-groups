var armies = {
  ...
  elite: {
    name: 'Elite Troops',
    joinbattle: 10,
    attacks: [{ type: 'Slashing sword', dice: 11, damage: 12, minimum: 2 }],
    magnitude: 7,
    soak: 10,
    command: 0,
    routdiff: 1,
  ...
  zombie: {
    name: 'Zombies',
    joinbattle: 2,
    attacks: [{ type: 'Bite', dice: 5, damage: 16 }],
    magnitude: 10,
    soak: 3,
    command: 0,
    routdiff: 100,
  ...
  warghost: {
    name: 'War Ghosts',
    joinbattle: 5,
    attacks: [{ type: 'Sword', dice: 7, damage: 12, minimum: 2 }],
    magnitude: 11,
    soak: 8,
    command: 0,
    routdiff: 1,
  ...
  bonesider: {
    name: 'Bonesiders',
    joinbattle: 6,
    attacks: [{ type: 'Claw', dice: 6, damage: 11 }],
    magnitude: 7,
    soak: 4,
    command: 0,
    routdiff: 1,
  ...
  bloodape: {
    name: 'Blood Apes',
    joinbattle: 6,
    attacks: [{ type: 'Claws', dice: 11, damage: 15 }],
    magnitude: 9,
    soak: 7,
    command: 0,
    routdiff: 1,
  ...
  walkuren: {
    name: 'Walkuren',
    joinbattle: 9,
    attacks: [{ type: 'Longspear', dice: 9, damage: 14 }],
    magnitude: 9,
    soak: 9,
    command: 0,
    routdiff: 1,
  ...
  griefbees: {
    name: 'Griefbees',
    joinbattle: 5,
    attacks: [{ type: 'Sting', dice: 4, damage: 4 }],
    magnitude: 7,
    soak: 4,
    command: 0,
    routdiff: 1,
  ...
  grelidaka: {
    ...
    joinbattle: 8,
    attacks: [
      { type: 'Claw', dice: 6, damage: 9 },
      { type: 'Peck', dice: 6, damage: 5 },
    ],
    magnitude: 5,
    soak: 2,
    command: 0,
  ...
  lavamoth: {
    name: 'Lava Moths',
    joinbattle: 6,
    attacks: [{ type: 'Wing buffet', dice: 9, damage: 9 }],
    magnitude: 9,
    soak: 6,
    command: 0,
    routdiff: 1,
